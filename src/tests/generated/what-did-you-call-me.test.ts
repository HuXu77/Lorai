...
describe('What Did You Call Me?', () => {
    ...
    beforeEach(() => {
        ...
        card = player.addCardToZone({
            ...
            lore: 0,
            inkwell: true,
            parsedEffects: [{"trigger":"on_play","action":"temp_stat_buff","target":"chosen_character","duration":"until_end_of_turn","rawText":"Chosen damaged character gets +3 ¤ this turn.","params":{"stat":"strength","amount":3}}]
