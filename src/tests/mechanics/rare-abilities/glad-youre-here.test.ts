...
describe('Rare Ability: GLAD YOU\'RE HERE!', () => {
    ...
    it('should have GLAD YOU\'RE HERE ability when in play', async () => {
        // Setup: P1 has Mickey Mouse - Friendly Face in play
        await harness.setPlay(harness.p1Id, ['Mickey Mouse - Friendly Face']);
    ...
    it('should register Mickey with triggered ability', async () => {
        ...
        // GLAD YOU'RE HERE! reduces cost when Mickey quests
        expect(mickey).toBeDefined();
    });
});
