...
describe('Parser Batch 19', () => {
    ...
    describe('Family Fishing Pole', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "effect": "Return chosen exerted character of yours to your hand to gain 2 lore.",
                    "fullText": "THE PERFECT CAST ⟳, 1 ⬡, Banish this item —\\nReturn chosen exerted character of yours to your\\nhand to gain 2 lore.",
    ...
    describe('Hidden Cove - Tranquil Haven', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Characters get +1 ¤ and +1 ⛉ while here.",
                ...
                fullTextSections: [
          "REVITALIZING WATERS Characters get +1 ¤ and +1 ⛉ while here."
],
                cost: 1,
    ...
    describe('Shere Khan - Menacing Predator', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "DON'T INSULT MY INTELLIGENCE Whenever one\\nof your characters challenges another character,\\ngain 1 lore."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Powerline - World\'s Greatest Rock Star', () => {
        it('should parse 3 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "keywordValue": "4",
                    "keywordValueNumber": 4,
                    "reminderText": "You may pay 4 ⬡ to play this on top of one of your characters named Powerline.",
                    "type": "keyword"
          },
          {
                    "fullText": "Singer 9",
    ...
    describe('Mickey Mouse - Brave Little Prince', () => {
        it('should parse 3 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "CROWNING ACHIEVEMENT While this character has a card\\nunder him, he gets +3 ¤, +3 ⛉, and +3 ◊.",
    ...
    describe('Roxanne - Powerline Fan', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "While you have a character with Singer in play, this character gets +1 ¤ and +1 ◊.",
    ...
    describe('P.J. Pete - Caught Up in the Music', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Whenever you play a song, this character gets +2 ¤ this turn.",
                ...
                fullTextSections: [
          "SHOUT OUT LOUD! Whenever you play a song, this\\ncharacter gets +2 ¤ this turn."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Queen of Hearts - Sensing Weakness', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "reminderText": "You may pay 2 ⬡ to play this on top of one of your characters named Queen of Hearts.",
                    "type": "keyword"
          },
          {
                    "effect": "Whenever one of your characters challenges another character, you may draw a card.",
                    "fullText": "LET THE GAME BEGIN Whenever one of your\\ncharacters challenges another character, you may\\ndraw a card.",
    ...
    describe('Mulan - Injured Soldier', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "BATTLE WOUND This character enters play with\\n2 damage."
],
                cost: 1,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Raya - Headstrong', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "During your turn, whenever this character banishes another character in a challenge, you may ready this character. If you do, she can't quest for the rest of this turn.",
                ...
                fullTextSections: [
          "NOTE TO SELF, DON'T DIE During your turn, whenever\\nthis character banishes another character in a\\nchallenge, you may ready this character. If you do,\\nshe can't quest for the rest of this turn."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Tuk Tuk - Lively Partner', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "When you play this character, you may move him and one of your other characters to the same location for free. If you do, the other character gets +2 ¤ this turn.",
    ...
    describe('A Pirate\'s Life', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "reminderText": "Any number of your or your teammates' characters with total cost 6 or more may ⟳ to sing this song for free.",
                    "type": "keyword"
          }
],
                fullTextSections: [
    ...
    describe('Medallion Weights', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "costsText": "⟳, 2 ⬡",
                    "effect": "Chosen character gets +2 ¤ this turn. Whenever they challenge another character this turn, you may draw a card.",
                ...
                fullTextSections: [
          "DISCIPLINE AND STRENGTH ⟳, 2 ⬡ — Chosen\\ncharacter gets +2 ¤ this turn. Whenever they\\nchallenge another character this turn, you may\\ndraw a card."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Dinner Bell', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "YOU KNOW WHAT HAPPENS ⟳, 2 ⬡ — Draw cards\\nequal to the damage on chosen character of yours,\\nthen banish them."
],
                cost: 4,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Anna - True-Hearted', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Whenever this character quests, your other Hero characters get +1 ◊ this turn.",
    ...
    describe('Mulan - Considerate Diplomat', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "IMPERIAL INVITATION Whenever this character\\nquests, look at the top 4 cards of your deck. You\\nmay reveal a Princess character card and put it\\ninto your hand. Put the rest on the bottom of your\\ndeck in any order."
],
                cost: 5,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Cruella De Vil - Style Icon', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "INSULTING REMARK During your turn, each opposing\\ncharacter with cost 2 or less gets -1 ¤.",
                    "name": "INSULTING REMARK",
                    "type": "static"
          }
],
                fullTextSections: [
          "OUT OF SEASON Once during your turn, whenever\\na character with cost 2 or less is banished, put the\\ntop card of your deck into your inkwell facedown\\nand exerted.",
    ...
    describe('Cruella De Vil - Fashionable Cruiser', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "NOW GET GOING During your turn, this character\\ngains Evasive. (They can challenge characters\\nwith Evasive.)"
],
                cost: 2,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Jasmine - Heir of Agrabah', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "I'M A FAST LEARNER When you play this character,\\nremove up to 1 damage from chosen character\\nof yours."
],
                cost: 1,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Belle - Inventive Engineer', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "TINKER Whenever this character quests, you pay\\n1 ⬡ less for the next item you play this turn."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Judy Hopps - Optimistic Officer', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, you may banish chosen item. If you do, its player draws a card.",
    ...
    describe('Alice - Growing Girl', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "WHAT DID I DO? While this character has 10 ¤\\nor more, she gets +4 ◊.",
                    "name": "WHAT DID I DO?",
                    "type": "static"
          }
],
                fullTextSections: [
          "GOOD ADVICE Your other characters gain\\nSupport. (Whenever they quest, you may add their\\n¤ to another chosen character's ¤ this turn.)",
    ...
    describe('One Jump Ahead', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "(A character with cost 2 or more can ⟳ to sing this song\\nfor free.)",
    ...
    describe('Heart of Te Fiti', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "CREATE LIFE ⟳, 2 ⬡ — Put the top card of your deck\\ninto your inkwell facedown and exerted."
],
                cost: 3,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Coconut Basket', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "CONSIDER THE COCONUT Whenever you play a character, you\\nmay remove up to 2 damage from chosen character."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Nala - Undaunted Lioness', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "While this character has no damage, she gets +1 ◊ and gains Resist +1. (Damage dealt to them is reduced by 1.)",
    ...
    describe('Lilo - Best Explorer Ever', () => {
        it('should parse 2 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, your other characters gain Challenger +2 this turn. (They get +2 ¤ while challenging.)",
    ...
    describe('Little John - Sir Reginald', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, choose one: • Chosen Hero character gains Resist +2 this turn. (Damage dealt to them is reduced by 2.) • Deal 2 damage to chosen Villain character.",
                ...
                fullTextSections: [
          "WHAT A BEAUTIFUL BRAWL! When you play this\\ncharacter, choose one:\\n• Chosen Hero character gains Resist +2 this turn.\\n(Damage dealt to them is reduced by 2.)\\n• Deal 2 damage to chosen Villain character."
],
                cost: 2,
                type: 'Character' as CardType,
                inkwell: false,
    ...
    describe('Jasmine - Fearless Princess', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "effect": "This character gains Challenger +3 this turn. (They get +3 ¤ while challenging.)",
                    "fullText": "NOW'S MY CHANCE Choose and discard a card — This\\ncharacter gains Challenger +3 this turn. (They get +3 ¤\\nwhile challenging.)",
                    "name": "NOW'S MY CHANCE",
                    "type": "activated"
          }
],
                fullTextSections: [
          "TAKE THE LEAP During your turn, this character gains\\nEvasive. (They can challenge characters with Evasive.)",
    ...
    describe('Tinker Bell - Tiny Tactician', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "BATTLE PLANS ⟳ — Draw a card, then choose and\\ndiscard a card."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Ariel - Sonic Warrior', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "keywordValue": "4",
                    "keywordValueNumber": 4,
                    "reminderText": "You may pay 4 ⬡ to play this on top of one of your characters named Ariel.",
                    "type": "keyword"
          },
          {
                    "effect": "Whenever you play a song, you may pay 2 ⬡ to deal 3 damage to chosen character.",
    ...
    describe('Beast\'s Mirror', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "SHOW ME ⟳, 3 ⬡ — If you have no cards in your hand,\\ndraw a card."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Beast - Gracious Prince', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "FULL DANCE CARD Your Princess characters\\nget +1 ¤ and +1 ⛉.",
                    "name": "FULL DANCE CARD",
                    "type": "static"
          }
],
                fullTextSections: [
          "FULL DANCE CARD Your Princess characters\\nget +1 ¤ and +1 ⛉."
],
                cost: 5,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Belle - Accomplished Mystic', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "ENHANCED HEALING When you play this\\ncharacter, move up to 3 damage counters\\nfrom chosen character to chosen opposing\\ncharacter.",
                ...
                fullTextSections: [
          "Shift 3 ⬡",
          "ENHANCED HEALING When you play this\\ncharacter, move up to 3 damage counters\\nfrom chosen character to chosen opposing\\ncharacter."
],
                cost: 5,
                type: 'Character' as CardType,
                inkwell: true,
