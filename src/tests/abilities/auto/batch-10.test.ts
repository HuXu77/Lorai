...
describe('Parser Batch 10', () => {
    ...
    describe('Obscurosphere', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "EXTRACT OF EMERALD 2 ⬡, Banish this item — Your\\ncharacters gain Ward until the start of your next turn.\\n(Opponents can't choose them except to challenge.)"
],
                cost: 1,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Sherwood Forest - Outlaw Hideaway', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "Characters gain Ward and “⟳, 1 ⬡ — Deal 2 damage to chosen damaged character” while here. (Opponents can't choose them except to challenge.)",
                    "fullText": "FAMILIAR TERRAIN Characters gain Ward and “⟳, 1 ⬡ — Deal 2 damage to chosen\\ndamaged character” while here. (Opponents can't choose them except to challenge.)",
    ...
    describe('Potion of Might', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "VILE CONCOCTION 1 ⬡, Banish this item — Chosen\\ncharacter gets +3 ¤ this turn. If a Villain character is\\nchosen, they get +4 ¤ instead."
],
                cost: 1,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Ruby Chromicon', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "RUBY LIGHT ⟳ — Chosen character gets +1 ¤ this\\nturn."
],
                cost: 1,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Sugar Rush Speedway - Starting Line', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Once per turn, you may ⟳ chosen character here and deal them 1 damage to move them to another location for free.",
                ...
                fullTextSections: [
          "ON YOUR MARKS! Once per turn, you may ⟳ chosen character here and\\ndeal them 1 damage to move them to another location for free."
],
                cost: 1,
                type: 'Location' as CardType,
                inkwell: false,
    ...
    describe('The Queen - Fairest of All', () => {
        it('should parse 3 abilities', () => {
          ...
          {
                    "effect": "For each other character named The Queen you have in play, this character gets +1 ◊.",
    ...
    describe('Medal of Heroes', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "costsText": "⟳, 2 ⬡, Banish this item",
                    "effect": "Chosen character of yours gets +2 ◊ this turn.",
                ...
                fullTextSections: [
          "CONGRATULATIONS, SOLDIER ⟳, 2 ⬡, Banish this item\\n— Chosen character of yours gets +2 ◊ this turn."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Basil\'s Magnifying Glass', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "FIND WHAT'S HIDDEN ⟳, 2 ⬡ — Look at the top 3\\ncards of your deck. You may reveal an item card and\\nput it into your hand. Put the rest on the bottom of\\nyour deck in any order."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Merlin\'s Carpetbag', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "HOCKETY POCKETY ⟳, 1 ⬡ — Return an item card\\nfrom your discard to your hand."
],
                cost: 5,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Sapphire Chromicon', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "costsText": "⟳, 2 ⬡, Banish one of your items",
                    "effect": "Gain 2 lore.",
                    "fullText": "SAPPHIRE LIGHT ⟳, 2 ⬡, Banish one of your items —\\nGain 2 lore.",
                    "name": "SAPPHIRE LIGHT",
                    "type": "activated"
          }
],
    ...
    describe('The Great Illuminary - Radiant Ballroom', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Characters with Support get +1 ◊ and +2 ⛉ while here.",
                ...
                fullTextSections: [
          "WARM WELCOME Characters with Support get +1 ◊ and +2 ⛉ while here."
],
                cost: 3,
                type: 'Location' as CardType,
                inkwell: true,
    ...
    describe('Pete - Wrestling Champ', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "RE-PETE ⟳ – Reveal the top card of your deck.\\nIf it's a character card named Pete, you may play\\nit for free."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: false,
    ...
    describe('Food Fight!', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [],
                fullTextSections: [
          "Your characters gain “⟳, 1 ⬡ — Deal 1 damage to chosen\\ncharacter” this turn."
],
                cost: 1,
                type: 'Action' as CardType,
                inkwell: false,
    ...
    describe('Shield of Arendelle', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "DEFLECT Banish this item — Chosen character gains\\nResist +1 until the start of your next turn. (Damage\\ndealt to them is reduced by 1.)"
],
                cost: 1,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Plate Armor', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "WELL CRAFTED ⟳ — Chosen character gains Resist +2\\nuntil the start of your next turn. (Damage dealt to them\\nis reduced by 2.)"
],
                cost: 4,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Steel Chromicon', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "STEEL LIGHT ⟳ — Deal 1 damage to chosen character."
],
                cost: 6,
                type: 'Item' as CardType,
                inkwell: false,
