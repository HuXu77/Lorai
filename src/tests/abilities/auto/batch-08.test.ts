...
describe('Parser Batch 8', () => {
    ...
    describe('Imperial Proclamation', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Whenever one of your characters challenges another character, you pay 1 ⬡ less for the next character you play this turn.",
    ...
    describe('Medallion Weights', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "DISCIPLINE AND STRENGTH ⟳, 2 ⬡ — Chosen character\\ngets +2 ¤ this turn. Whenever they challenge another\\ncharacter this turn, you may draw a card.",
                    "name": "DISCIPLINE AND STRENGTH",
                    "type": "activated"
          }
],
                fullTextSections: [
          "DISCIPLINE AND STRENGTH ⟳, 2 ⬡ — Chosen character\\ngets +2 ¤ this turn. Whenever they challenge another\\ncharacter this turn, you may draw a card."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('The Plank', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "effect": "Choose one: • Banish chosen Hero character. • Ready chosen Villain character. They can't quest for the rest of this turn.",
                    "fullText": "WALK! 2 ⬡, Banish this item — Choose one:\\n• Banish chosen Hero character.\\n• Ready chosen Villain character. They can't quest for\\nthe rest of this turn.",
                    "name": "WALK!",
                    "type": "activated"
          }
],
                fullTextSections: [
          "WALK! 2 ⬡, Banish this item — Choose one:\\n• Banish chosen Hero character.\\n• Ready chosen Villain character. They can't quest for\\nthe rest of this turn."
],
                cost: 3,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Vitalisphere', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "effect": "Chosen character gains Rush and gets +2 ¤ this turn. (They can challenge the turn they're played.)",
                    "fullText": "EXTRACT OF RUBY 1 ⬡, Banish this item — Chosen\\ncharacter gains Rush and gets +2 ¤ this turn. (They\\ncan challenge the turn they're played.)",
                    "name": "EXTRACT OF RUBY",
                    "type": "activated"
          }
],
                fullTextSections: [
          "EXTRACT OF RUBY 1 ⬡, Banish this item — Chosen\\ncharacter gains Rush and gets +2 ¤ this turn. (They\\ncan challenge the turn they're played.)"
],
                cost: 1,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Training Grounds - Impossible Pillar', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "costsText": "1 ⬡",
                    "effect": "Chosen character here gets +1 ¤ this turn.",
                    "fullText": "STRENGTH OF MIND 1 ⬡ — Chosen character here gets +1 ¤ this turn.",
                    "name": "STRENGTH OF MIND",
                    "type": "activated"
          }
],
                fullTextSections: [
          "STRENGTH OF MIND 1 ⬡ — Chosen character here gets +1 ¤ this turn."
],
                cost: 1,
                type: 'Location' as CardType,
                inkwell: true,
    ...
    describe('Anna - Braving the Storm', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "If you have another Hero character in play, this character gets +1 ◊.",
    ...
    describe('Ariel - Treasure Collector', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "While you have more items in play than each opponent, this character gets +2 ◊.",
    ...
    describe('Aurora - Lore Guardian', () => {
        it('should parse 3 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "reminderText": "You may pay 2 ⬡ to play this on top of one of your characters named Aurora.",
                    "type": "keyword"
          },
          {
          ...
          "ROYAL INVENTORY ⟳ one of your items — Look at the top\\ncard of your deck and put it on either the top or the bottom\\nof your deck."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Dang Hu - Talon Chief', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Your other Villain characters gain Support. (Whenever they quest, you may add their ¤ to another chosen character's ¤ this turn.)",
    ...
    describe('Flounder - Collector\'s Companion', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "If you have a character named Ariel in play, you pay 1 ⬡ less to play this character.",
    ...
    describe('Olaf - Carrot Enthusiast', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "Whenever he quests, each of your other characters gets +¤ equal to this character's ¤ this turn.",
    ...
    describe('Triton - Champion of Atlantica', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "reminderText": "You may pay 6 ⬡ to play this on top of one of your characters named Triton.",
                    "type": "keyword"
          },
          {
                    "effect": "Opposing characters get -1 ¤ for each location you have in play.",
                    "fullText": "IMPOSING PRESENCE Opposing characters get -1 ¤\\nfor each location you have in play.",
          ...
          "IMPOSING PRESENCE Opposing characters get -1 ¤\\nfor each location you have in play."
],
                cost: 9,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Triton - Discerning King', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "effect": "Gain 3 lore.",
                    "fullText": "CONSIGN TO THE DEPTHS ⟳, Banish one of your\\nitems — Gain 3 lore.",
                    "name": "CONSIGN TO THE DEPTHS",
                    "type": "activated"
          }
],
                fullTextSections: [
          "CONSIGN TO THE DEPTHS ⟳, Banish one of your\\nitems — Gain 3 lore."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: false,
    ...
    describe('Great Stone Dragon', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "AWAKEN ⟳ — Put a character card from your discard\\ninto your inkwell facedown and exerted.",
                    "name": "AWAKEN",
                    "type": "activated"
          }
],
          ...
          "AWAKEN ⟳ — Put a character card from your discard\\ninto your inkwell facedown and exerted."
],
                cost: 3,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Ice Block', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "CHILLY LABOR ⟳ — Chosen character gets -1 ¤ this turn.",
                    "name": "CHILLY LABOR",
                    "type": "activated"
          }
],
                fullTextSections: [
          "CHILLY LABOR ⟳ — Chosen character gets -1 ¤ this turn."
],
                cost: 1,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Ariel\'s Grotto - A Secret Place', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "While you have 3 or more items in play, this location gets +2 ◊.",
    ...
    describe('Donald Duck - Buccaneer', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "During your turn, whenever this character banishes a character in a challenge, your other characters get +1 ◊ this turn.",
    ...
    describe('Ling - Imperial Soldier', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Your Hero characters get +1 ¤.",
                    "fullText": "FULL OF SPIRIT Your Hero characters get +1 ¤.",
                    "name": "FULL OF SPIRIT",
                    "type": "static"
          }
],
                fullTextSections: [
          "FULL OF SPIRIT Your Hero characters get +1 ¤."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Luisa Madrigal - Rock of the Family', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "While you have another character in play, this character gets +2 ¤.",
    ...
    describe('Magic Broom - Brigade Commander', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "This character gets +2 ¤ for each other character named Magic Broom you have in play.",
                    "fullText": "ARMY OF BROOMS This character gets +2 ¤ for\\neach other character named Magic Broom you\\nhave in play.",
                    "name": "ARMY OF BROOMS",
                    "type": "static"
          }
],
                fullTextSections: [
          "Resist +1 (Damage dealt to this character is\\nreduced by 1.)",
          "ARMY OF BROOMS This character gets +2 ¤ for\\neach other character named Magic Broom you\\nhave in play."
],
                cost: 6,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Fortisphere', () => {
        it('should parse 2 abilities', () => {
          ...
          "EXTRACT OF STEEL 1 ⬡, Banish this item — Chosen character\\nof yours gains Bodyguard until the start of your next turn.\\n(An opposing character who challenges one of your characters\\nmust choose one with Bodyguard if able.)"
],
                cost: 1,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Imperial Bow', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "costsText": "⟳, 1 ⬡",
                    "effect": "Chosen Hero character gains Challenger +2 and Evasive this turn. (They get +2 ¤ while challenging. They can challenge characters with Evasive.)",
                    "fullText": "WITHIN RANGE ⟳, 1 ⬡ — Chosen Hero character\\ngains Challenger +2 and Evasive this turn. (They\\nget +2 ¤ while challenging. They can challenge\\ncharacters with Evasive.)",
                    "name": "WITHIN RANGE",
                    "type": "activated"
          }
],
                fullTextSections: [
          "WITHIN RANGE ⟳, 1 ⬡ — Chosen Hero character\\ngains Challenger +2 and Evasive this turn. (They\\nget +2 ¤ while challenging. They can challenge\\ncharacters with Evasive.)"
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('RLS Legacy\'s Cannon', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "BA-BOOM! ⟳, 2 ⬡, Discard a card — Deal 2 damage\\nto chosen character or location.",
                    "name": "BA-BOOM!",
                    "type": "activated"
          }
],
                fullTextSections: [
          "BA-BOOM! ⟳, 2 ⬡, Discard a card — Deal 2 damage\\nto chosen character or location."
],
                cost: 3,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Cinderella - Melody Weaver', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "Whenever this character sings a song, your other Princess characters get +1 ◊ this turn.",
    ...
    describe('We Don\'t Talk About Bruno', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "(A character with cost 5 or more can ⟳ to sing this song\\nfor free.)",
                    "type": "static"
          }
],
                fullTextSections: [
          "(A character with cost 5 or more can ⟳ to sing this song\\nfor free.)",
    ...
    describe('Capsize', () => {
        it('should parse 2 abilities', () => {
            const card = {
                ...
                abilities: [],
                fullTextSections: [
          "If you have 6 ⬡ or less, put the top 3 cards of your\\ndeck into your inkwell facedown.",
          "If you have 7 ⬡ or more, each opposing player chooses\\nand banishes one of their characters."
],
                cost: 3,
                type: 'Action' as CardType,
                inkwell: true,
