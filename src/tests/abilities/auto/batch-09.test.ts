...
describe('Parser Batch 9', () => {
    ...
    describe('Riptide', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [],
                fullTextSections: [
          "Banish all opposing characters, items, and locations\\nwith cost 2 or less."
],
                cost: 6,
                type: 'Action' as CardType,
                inkwell: true,
    ...
    describe('Tentacle Swipe', () => {
        it('should parse 1 abilities', () => {
            const card = {
                id: 938,
                name: 'Tentacle Swipe',
                
                fullName: 'Tentacle Swipe',
                abilities: [],
                fullTextSections: [
          "Deal 1 damage to each opposing character. Then, put\\nthis card into your inkwell facedown."
],
                cost: 2,
                type: 'Action' as CardType,
                inkwell: true,
    ...
    describe('Typhoon', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [],
                fullTextSections: [
          "Return all opposing exerted characters to their players'\\nhands."
],
                cost: 5,
                type: 'Action' as CardType,
                inkwell: true,
    ...
    describe('Whirlpool', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [],
                fullTextSections: [
          "Exert all opposing characters. They can't ready at the\\nstart of the their next turn."
],
                cost: 4,
                type: 'Action' as CardType,
                inkwell: true,
    ...
    describe('The Hexwell Crown', () => {
        it('should parse 1 abilities', () => {
            const card = {
                id: 942,
                name: 'The Hexwell Crown',
                
                fullName: 'The Hexwell Crown',
                abilities: [
          {
                    "costs": [
                              "⟳"
                    ...
                    "costsText": "⟳",
                    "effect": "Draw a card.",
                    "fullText": "PERKS OF POWER ⟳ — Draw a card.",
                    "name": "PERKS OF POWER",
                    "type": "activated"
          }
],
                fullTextSections: [
          "PERKS OF POWER ⟳ — Draw a card."
],
                cost: 3,
    ...
    describe('Ursula\'s Contract', () => {
        it('should parse 2 abilities', () => {
            const card = {
                id: 943,
                name: 'Ursula\'s Contract',
                
                fullName: 'Ursula\'s Contract',
                abilities: [
          {
                    "effect": "Opposing players can't use battleground abilities.",
                    "fullText": "SWEETEN THE DEAL Opposing players can't use\\nbattleground abilities.",
                    "name": "SWEETEN THE DEAL",
                    "type": "static"
          },
          {
                    "effect": "At the start of your turn, banish this item to gain 3 lore.",
                    "fullText": "MINOR STIPULATION At the start of your turn, banish\\nthis item to gain 3 lore.",
                    "name": "MINOR STIPULATION",
                    "type": "triggered"
          }
],
                fullTextSections: [
          "SWEETEN THE DEAL Opposing players can't use\\nbattleground abilities.",
          "MINOR STIPULATION At the start of your turn, banish\\nthis item to gain 3 lore."
],
                cost: 0,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Ursula\'s Stolen Trident', () => {
        it('should parse 1 abilities', () => {
            const card = {
                id: 944,
                name: 'Ursula\'s Stolen Trident',
                
                fullName: 'Ursula\'s Stolen Trident',
                abilities: [
          {
                    "costs": [
                              "⟳"
                    ...
                    "costsText": "⟳",
                    "effect": "Gain 1 lore.",
                    "fullText": "IT'S MY POWER NOW ⟳ — Gain 1 lore.",
                    "name": "IT'S MY POWER NOW",
                    "type": "activated"
          }
],
                fullTextSections: [
          "IT'S MY POWER NOW ⟳ — Gain 1 lore."
],
                cost: 0,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Yen Sid - Powerful Sorcerer', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "While you have 2 or more Broom characters in play, this character gets +2 ◊.",
    ...
    describe('Ursula\'s Lair - Eye of the Storm', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "Characters named Ursula get +1 ◊ while here.",
                    "fullText": "SEAT OF POWER Characters named Ursula get +1 ◊ while here.",
                    "name": "SEAT OF POWER",
                    "type": "static"
          }
],
    ...
    describe('Hidden Inkcaster', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "All cards in your hand count as having ◉.",
    ...
    describe('Koda - Talkative Cub', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "During opponents' turns, you can't lose lore.",
                ...
                fullTextSections: [
          "TELL EVERYBODY During opponents' turns, you\\ncan't lose lore."
],
                cost: 2,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Prince Naveen - Ukulele Player', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                ...
                fullTextSections: [
          "Singer 6 (This character counts as cost 6 to sing\\nsongs.)",
    ...
    describe('Kenai - Big Brother', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "While this character is exerted, your characters named Koda can't be challenged.",
                ...
                fullTextSections: [
          "BROTHERS FOREVER While this character is exerted,\\nyour characters named Koda can't be challenged."
],
                cost: 2,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Vanellope von Schweetz - Candy Mechanic', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Whenever this character quests, chosen opposing character gets -1 ¤ until the start of your next turn.",
    ...
    describe('Fix-It Felix, Jr. - Niceland Steward', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "keywordValue": "3",
                    "keywordValueNumber": 3,
                    "reminderText": "You may pay 3 ⬡ to play this on top of one of your characters named Fix-It Felix, Jr.",
                    "type": "keyword"
          },
          {
                    "effect": "Your locations get +2 ⛉.",
                    "fullText": "BUILDING TOGETHER Your locations get +2 ⛉.",
    ...
    describe('Kristoff - Reindeer Keeper', () => {
        it('should parse 2 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "For each song card in your discard, you pay 1 ⬡ less to play this character.",
    ...
    describe('Minnie Mouse - Drum Major', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "reminderText": "You may pay 4 ⬡ to play this on top of one of your characters named Minnie Mouse.",
                    "type": "keyword"
          },
          {
                    "effect": "When you play this character, if you used Shift to play her, you may search your deck for a character card and reveal that card to all players. Shuffle your deck and put that card on top of it.",
                    "fullText": "PARADE ORDER When you play this character, if you\\nused Shift to play her, you may search your deck for\\na character card and reveal that card to all players.\\nShuffle your deck and put that card on top of it.",
                    "name": "PARADE ORDER",
                    "type": "triggered"
          }
],
    ...
    describe('Daisy Duck - Donald\'s Date', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Whenever this character quests, each opponent reveals the top card of their deck. If it's a character card, they may put it into their hand. Otherwise, they put it on the bottom of their deck.",
    ...
    describe('Fix-It Felix, Jr. - Delighted Sightseer', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, if you have a location in play, draw a card.",
    ...
    describe('Vanellope von Schweetz - Sugar Rush Princess', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "reminderText": "You may pay 2 ⬡ to play this on top of one of your characters named Vanellope von Schweetz.",
                    "type": "keyword"
          },
          {
    ...
    describe('Alan-a-Dale - Rockin\' Rooster', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Whenever you play a song, gain 1 lore.",
    ...
    describe('Wreck-It Ralph - Admiral Underpants', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, return a character card from your discard to your hand. If that card is a Princess character card, gain 2 lore.",
    ...
    describe('Maid Marian - Lady of the Lists', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, chosen opposing character gets -5 ¤ until the start of your next turn.",
                ...
                fullTextSections: [
          "IF IT PLEASES THE LADY When you play this\\ncharacter, chosen opposing character gets -5 ¤\\nuntil the start of your next turn."
],
                cost: 6,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Sven - Reindeer Steed', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, you may ready chosen character. They can't quest or challenge for the rest of this turn.",
    ...
    describe('Minnie Mouse - Compassionate Friend', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "PATCH THEM UP Whenever this character quests,\\nyou may remove up to 2 damage from chosen\\ncharacter."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Try Everything', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "(A character with cost 4 or more can ⟳ to sing this song for\\nfree.)",
    ...
    describe('Revive', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [],
                fullTextSections: [
          "Play a character card with cost 5 or less from your\\ndiscard for free."
],
                cost: 5,
                type: 'Action' as CardType,
                inkwell: false,
    ...
    describe('Blast from Your Past', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "(A character with cost 6 or more can ⟳ to sing this\\nsong for free.)",
    ...
    describe('Healing Decanter', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "RENEWING ESSENCE ⟳ — Remove up to 2 damage\\nfrom chosen character."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Queen\'s Sensor Core', () => {
        it('should parse 2 abilities', () => {
            const card = {
                ...
                fullName: 'Queen\'s Sensor Core',
                abilities: [
          {
                    "effect": "At the start of your turn, if you have a Princess or Queen character in play, gain 1 lore.",
          ...
          },
          {
                    ...
                    "costsText": "⟳, 2 ⬡",
                    "effect": "Reveal the top card of your deck. If it's a Princess or Queen character card, you may put it into your hand. Otherwise, put it on the top of your deck.",
                    "fullText": "ROYAL SEARCH ⟳, 2 ⬡ — Reveal the top card of your deck.\\nIf it's a Princess or Queen character card, you may put it into\\nyour hand. Otherwise, put it on the top of your deck.",
                    "name": "ROYAL SEARCH",
                    "type": "activated"
          }
],
    ...
    describe('Amber Chromicon', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "costsText": "⟳",
                    "effect": "Remove up to 1 damage from each of your characters.",
                ...
                fullTextSections: [
          "AMBER LIGHT ⟳ — Remove up to 1 damage from each\\nof your characters."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Rapunzel\'s Tower - Secluded Prison', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Characters get +3 ⛉ while here.",
                ...
                fullTextSections: [
          "SAFE AND SOUND Characters get +3 ⛉ while here."
],
                cost: 2,
                type: 'Location' as CardType,
                inkwell: true,
    ...
    describe('Pride Lands - Jungle Oasis', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "While you have 3 or more characters here, you may banish this location to play a character from your discard for free.",
                ...
                fullTextSections: [
          "OUR HUMBLE HOME While you have 3 or more characters here, you may\\nbanish this location to play a character from your discard for free."
],
                cost: 3,
                type: 'Location' as CardType,
                inkwell: true,
    ...
    describe('Maleficent - Formidable Queen', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "keywordValue": "6",
                    "keywordValueNumber": 6,
                    "reminderText": "You may pay 6 ⬡ to play this on top of one of your characters named Maleficent.",
                    "type": "keyword"
          },
          {
                    "effect": "When you play this character, for each of your characters named Maleficent in play, return a chosen opposing character, item, or location with cost 3 or less to their player's hand.",
                    "fullText": "LISTEN WELL, ALL OF YOU When you play this character,\\nfor each of your characters named Maleficent in play,\\nreturn a chosen opposing character, item, or location\\nwith cost 3 or less to their player's hand.",
    ...
    describe('The Nokk - Mythical Spirit', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "TURNING TIDES When you play this character,\\nyou may move up to 2 damage counters from\\nchosen character to chosen opposing character."
],
                cost: 6,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Cogsworth - Illuminary Watchman', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, chosen character gains Rush this turn. (They can challenge the turn they're played.)",
                ...
                fullTextSections: [
          "TIME TO MOVE IT! When you play this character,\\nchosen character gains Rush this turn. (They can\\nchallenge the turn they're played.)"
],
                cost: 1,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Merlin - Turtle', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character and when he leaves play, look at the top 2 cards of your deck. Put one on the top of your deck and the other on the bottom.",
                ...
                fullTextSections: [
          "GIVE ME TIME TO THINK When you play this\\ncharacter and when he leaves play, look at the\\ntop 2 cards of your deck. Put one on the top of\\nyour deck and the other on the bottom."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Bruni - Fire Salamander', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "PARTING GIFT When this character is banished,\\nyou may draw a card.",
                    "name": "PARTING GIFT",
                    "type": "triggered"
          }
],
    ...
    describe('Earth Giant - Living Mountain', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, each opponent draws a card.",
                ...
                fullTextSections: [
          "UNEARTHED When you play this character, each\\nopponent draws a card."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Gale - Wind Spirit', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "RECURRING GUST When this character is\\nbanished in a challenge, return this card to your\\nhand."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Madam Mim - Elephant', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "At the start of your turn, you may move up to 2 damage counters from this character to chosen opposing character.",
                    "fullText": "SNEAKY MOVE At the start of your turn, you may move\\nup to 2 damage counters from this character to chosen\\nopposing character.",
                    "name": "SNEAKY MOVE",
                    "type": "triggered"
          }
],
                fullTextSections: [
          "A LITTLE GAME When you play this character, banish\\nher or return another chosen character of yours to your\\nhand.",
    ...
    describe('Anna - Mystical Majesty', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "When you play this character, exert all opposing characters.",
                    "fullText": "EXCEPTIONAL POWER When you play this\\ncharacter, exert all opposing characters.",
    ...
    describe('Archimedes - Electrified Owl', () => {
        it('should parse 3 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "keywordValue": "3",
                    "keywordValueNumber": 3,
                    "reminderText": "You may pay 3 ⬡ to play this on top of one of your characters named Archimedes.",
                    "type": "keyword"
          },
          {
          ...
          {
                    "fullText": "Challenger +3 (While challenging, this character gets +3 ¤.)",
                    "keyword": "Challenger",
                    "keywordValue": "+3",
                    "keywordValueNumber": 3,
    ...
    describe('Genie - Main Attraction', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "While this character is exerted, opposing characters can't ready at the start of their turn.",
                ...
                fullTextSections: [
          "PHENOMENAL SHOWMAN While this character is\\nexerted, opposing characters can't ready at the\\nstart of their turn."
],
                cost: 7,
                type: 'Character' as CardType,
                inkwell: false,
    ...
    describe('Olaf - Happy Passenger', () => {
        it('should parse 2 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "For each exerted character opponents have in play, you pay 1 ⬡ less to play this character.",
    ...
    describe('Maleficent - Vexed Partygoer', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Whenever this character quests, you may choose and discard a card to return chosen character, item, or location with cost 3 or less to their player's hand.",
                ...
                fullTextSections: [
          "WHAT AN AWKWARD SITUATION Whenever this\\ncharacter quests, you may choose and discard a\\ncard to return chosen character, item, or location\\nwith cost 3 or less to their player's hand."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Magica De Spell - Cruel Sorceress', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "During opponents' turns, if an effect would cause you to discard one or more cards from your hand, you don't discard.",
    ...
    describe('Rafiki - Shaman Duelist', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "When you play this character, he gains Challenger +4 this turn. (They get +4 ¤ while challenging.)",
                    "fullText": "SURPRISING SKILL When you play this character,\\nhe gains Challenger +4 this turn. (They get +4 ¤\\nwhile challenging.)",
    ...
    describe('Anna - Eager Acolyte', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, each opponent chooses and exerts one of their ready characters.",
                ...
                fullTextSections: [
          "GROWING POWERS When you play this character,\\neach opponent chooses and exerts one of their\\nready characters."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: false,
    ...
    describe('King of Hearts - Monarch of Wonderland', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "costsText": "⟳",
                    "effect": "Chosen exerted character can't ready at the start of their next turn.",
                ...
                fullTextSections: [
          "PLEASING THE QUEEN ⟳ — Chosen exerted\\ncharacter can't ready at the start of their next\\nturn."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Camilo Madrigal - Family Copycat', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Whenever this character quests, you may gain lore equal to the ◊ of chosen other character of yours. Return that character to your hand.",
    ...
    describe('Hypnotic Strength', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                fullName: 'Hypnotic Strength',
                abilities: [],
                fullTextSections: [
          "Draw a card. Chosen character gains Challenger +2\\nthis turn. (They get +2 ¤ while challenging.)"
],
                cost: 2,
                type: 'Action' as CardType,
                inkwell: true,
    ...
    describe('Gathering Knowledge and Wisdom', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                fullName: 'Gathering Knowledge and Wisdom',
                abilities: [],
                fullTextSections: [
          "Gain 2 lore."
],
    ...
    describe('Retrosphere', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "effect": "Return chosen character, item, or location with cost 3 or less to their player's hand.",
                ...
                fullTextSections: [
          "EXTRACT OF AMETHYST 2 ⬡, Banish this item — Return\\nchosen character, item, or location with cost 3 or less\\nto their player's hand."
],
                cost: 1,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Half Hexwell Crown', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "costsText": "⟳, 2 ⬡, Discard a card",
                    "effect": "Exert chosen character.",
                    "fullText": "A PERILOUS POWER ⟳, 2 ⬡, Discard a card — Exert\\nchosen character.",
                    "name": "A PERILOUS POWER",
                    "type": "activated"
          }
],
                fullTextSections: [
          "AN UNEXPECTED FIND ⟳, 2 ⬡ — Draw a card.",
    ...
    describe('Amethyst Chromicon', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "costsText": "⟳",
                    "effect": "Each player may draw a card.",
                ...
                fullTextSections: [
          "AMETHYST LIGHT ⟳ — Each player may draw a card."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('The Library - A Gift for Belle', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Whenever a character is banished while here, you may draw a card.",
                ...
                fullTextSections: [
          "LOST IN A BOOK Whenever a character is banished while here, you may\\ndraw a card."
],
                cost: 3,
                type: 'Location' as CardType,
                inkwell: true,
    ...
    describe('Robin Hood - Timely Contestant', () => {
        it('should parse 2 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "For each 1 damage on opposing characters, you pay 1 ⬡ less to play this character.",
          ...
          },
          {
                ...
                fullTextSections: [
          "TAG ME IN! For each 1 damage on opposing\\ncharacters, you pay 1 ⬡ less to play this\\ncharacter.",
    ...
    describe('Shenzi - Scar\'s Accomplice', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "While challenging a damaged character, this character gets +2 ¤.",
                    "fullText": "EASY PICKINGS While challenging a damaged\\ncharacter, this character gets +2 ¤.",
                    "name": "EASY PICKINGS",
                    "type": "static"
          }
],
    ...
    describe('Ulf - Mime', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "SILENT PERFORMANCE This character can't ⟳ to\\nsing songs."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Ed - Laughing Hyena', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "CAUSE A PANIC When you play this character,\\nyou may deal 2 damage to chosen damaged\\ncharacter."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: false,
    ...
    describe('Flora - Good Fairy', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "FIDDLE FADDLE While being challenged, this\\ncharacter gets +2 ¤."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Merryweather - Good Fairy', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, you may pay 1 ⬡ to give chosen character +2 ¤ this turn.",
                ...
                fullTextSections: [
          "RAY OF HOPE When you play this character, you\\nmay pay 1 ⬡ to give chosen character +2 ¤ this\\nturn."
],
                cost: 1,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Robin Hood - Archery Contestant', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, if an opponent has a damaged character in play, gain 1 lore.",
                ...
                fullTextSections: [
          "TRICK SHOT When you play this character, if an\\nopponent has a damaged character in play, gain 1\\nlore."
],
                cost: 2,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Iago - Fake Flamingo', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "Whenever this character quests, you pay 2 ⬡ less for the next action you play this turn.",
                    "fullText": "IN DISGUISE Whenever this character quests,\\nyou pay 2 ⬡ less for the next action you play this\\nturn.",
                    "name": "IN DISGUISE",
                    "type": "triggered"
          }
],
    ...
    describe('Ed - Hysterical Partygoer', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Damaged characters can't challenge this character.",
                ...
                fullTextSections: [
          "ROWDY GUEST Damaged characters can't\\nchallenge this character."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: false,
    ...
    describe('Scroop - Odious Mutineer', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "When you play this character, you may pay 3 ⬡ to banish chosen damaged character.",
                    "fullText": "DO SAY HELLO TO MR. ARROW When you play this\\ncharacter, you may pay 3 ⬡ to banish chosen\\ndamaged character.",
    ...
    describe('Prince Phillip - Swordsman of the Realm', () => {
        it('should parse 2 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, banish chosen opposing Dragon character.",
                    "fullText": "SLAYER OF DRAGONS When you play this character,\\nbanish chosen opposing Dragon character.",
                    "name": "SLAYER OF DRAGONS",
                    "type": "triggered"
          },
          {
                    "effect": "Whenever he challenges a damaged character, ready this character after the challenge.",
                    "fullText": "PRESSING THE ADVANTAGE Whenever he challenges\\na damaged character, ready this character after the\\nchallenge.",
                    "name": "PRESSING THE ADVANTAGE",
                    "type": "triggered"
          }
],
                fullTextSections: [
          "SLAYER OF DRAGONS When you play this character,\\nbanish chosen opposing Dragon character.",
    ...
    describe('Clarabelle - Light on Her Hooves', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "keywordValue": "5",
                    "keywordValueNumber": 5,
                    "reminderText": "You may pay 5 ⬡ to play this on top of one of your characters named Clarabelle.",
                    "type": "keyword"
          },
          {
    ...
    describe('Anna - Diplomatic Queen', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, you may pay 2 ⬡ to choose one: • Each opponent chooses and discards a card. • Chosen character gets +2 ¤ this turn. • Banish chosen damaged character.",
                ...
                fullTextSections: [
          "ROYAL RESOLUTION When you play this character,\\nyou may pay 2 ⬡ to choose one:\\n• Each opponent chooses and discards a card.\\n• Chosen character gets +2 ¤ this turn.\\n• Banish chosen damaged character."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: false,
    ...
    describe('Clarabelle - Clumsy Guest', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, you may pay 2 ⬡ to banish chosen item.",
                ...
                fullTextSections: [
          "BUTTERFINGERS When you play this character,\\nyou may pay 2 ⬡ to banish chosen item."
],
                cost: 1,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Banzai - Taunting Hyena', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, you may exert chosen damaged character.",
                ...
                fullTextSections: [
          "HERE KITTY, KITTY, KITTY When you play this\\ncharacter, you may exert chosen damaged\\ncharacter."
],
                cost: 2,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Robin Hood - Sneaky Sleuth', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "This character gets +1 ◊ for each opposing damaged character in play.",
                    "fullText": "CLEVER PLAN This character gets +1 ◊ for each\\nopposing damaged character in play.",
                    "name": "CLEVER PLAN",
                    "type": "static"
          }
],
    ...
    describe('Mother Gothel - Conceited Manipulator', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, you may pay 3 ⬡ to return chosen character to their player's hand.",
                ...
                fullTextSections: [
          "MOTHER KNOWS BEST When you play this\\ncharacter, you may pay 3 ⬡ to return chosen\\ncharacter to their player's hand."
],
                cost: 2,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Clarabelle - Contented Wallflower', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "ONE STEP BEHIND When you play this character,\\nif an opponent has more cards in their hand than\\nyou, you may draw a card."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Shenzi - Head Hyena', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                ...
                fullTextSections: [
          "STICK AROUND FOR DINNER This character gets +1 ¤\\nfor each other Hyena character you have in play.",
