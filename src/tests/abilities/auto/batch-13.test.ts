...
describe('Parser Batch 13', () => {
    ...
    describe('Cobra Bubbles - Former CIA', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "THINK ABOUT WHAT'S BEST 2 ⬡ — Draw a card,\\nthen choose and discard a card.",
                ...
                fullTextSections: [
          "Bodyguard (This character may enter play exerted.\\nAn opposing character who challenges one of\\nyour characters must choose one with Bodyguard\\nif able.)",
          "THINK ABOUT WHAT'S BEST 2 ⬡ — Draw a card,\\nthen choose and discard a card."
],
                cost: 5,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('John Silver - Stern Captain', () => {
        it('should parse 3 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "reminderText": "You may pay 5 ⬡ to play this on top of one of your characters named John Silver.",
                    "type": "keyword"
          },
          {
    ...
    describe('Ambush!', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [],
                fullTextSections: [
          "⟳ one of your characters to deal damage equal to\\ntheir ¤ to chosen character."
],
                cost: 3,
                type: 'Action' as CardType,
                inkwell: false,
    ...
    describe('King\'s Sensor Core', () => {
        it('should parse 2 abilities', () => {
          ...
          "ROYAL SEARCH ⟳, 2 ⬡ — Reveal the top card of your\\ndeck. If it's a Prince or King character card, you may\\nput that card into your hand. Otherwise, put it on the\\ntop of your deck."
],
                cost: 3,
    ...
    describe('Sunglasses', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "costsText": "⟳",
                    "effect": "Draw a card, then choose and discard a card.",
                    "fullText": "SPYCRAFT ⟳ — Draw a card, then choose and discard\\na card.",
                    "name": "SPYCRAFT",
                    "type": "activated"
          }
],
                fullTextSections: [
          "SPYCRAFT ⟳ — Draw a card, then choose and discard\\na card."
],
                cost: 4,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Yzma - Conniving Chemist', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "FEEL THE POWER ⟳ — If you have fewer than\\n3 cards in your hand, draw until you have 3\\ncards in your hand.",
                    "name": "FEEL THE POWER",
                    "type": "activated"
          }
],
                fullTextSections: [
          "FEEL THE POWER ⟳ — If you have fewer than\\n3 cards in your hand, draw until you have 3\\ncards in your hand."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Tigger - In the Crow\'s Nest', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "Whenever you play an action, this character gets +1 ¤ and +1 ◊ this turn.",
                    "fullText": "SWASH YOUR BUCKLES Whenever you play an\\naction, this character gets +1 ¤ and +1 ◊ this\\nturn.",
    ...
    describe('Baymax - Personal Healthcare Companion', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "YOU SAID ‘OW’ 2 ⬡ — Remove up to 1 damage\\nfrom another chosen character.",
                    "name": "YOU SAID ‘OW’",
                    "type": "activated"
          }
],
          ...
          "YOU SAID ‘OW’ 2 ⬡ — Remove up to 1 damage\\nfrom another chosen character."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Mickey Mouse - Pirate Captain', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "MARINER'S MIGHT Whenever this character quests,\\nchosen Pirate character gets +2 ¤ and gains “This\\ncharacter takes no damage from challenges” this turn.",
    ...
    describe('Rhino - Motivational Speaker', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Your other characters get +2 ⛉.",
                    "fullText": "DESTINY CALLING Your other characters get +2 ⛉.",
                    "name": "DESTINY CALLING",
                    "type": "static"
          }
],
                fullTextSections: [
          "DESTINY CALLING Your other characters get +2 ⛉."
],
                cost: 6,
                type: 'Character' as CardType,
                inkwell: false,
    ...
    describe('Peg - Natural Performer', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "CAPTIVE AUDIENCE ⟳ — If you have 3 or more\\nother characters in play, draw a card.",
                    "name": "CAPTIVE AUDIENCE",
                    "type": "activated"
          }
],
                fullTextSections: [
          "CAPTIVE AUDIENCE ⟳ — If you have 3 or more\\nother characters in play, draw a card."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Mittens - Sassy Street Cat', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "Once during your turn, whenever a card is put into your inkwell, your other characters with Bodyguard get +1 ◊ this turn.",
                    "fullText": "NO THANKS NECESSARY Once during your turn,\\nwhenever a card is put into your inkwell, your other\\ncharacters with Bodyguard get +1 ◊ this turn.",
    ...
    describe('Mariano Guzman - Handsome Suitor', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "While you have a character named Dolores Madrigal in play, this character gets +1 ◊.",
                    "fullText": "I SEE YOU While you have a character named\\nDolores Madrigal in play, this character gets +1 ◊.",
                    "name": "I SEE YOU",
                    "type": "static"
          }
],
    ...
    describe('Thunderbolt - Wonder Dog', () => {
        it('should parse 2 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "fullText": "Puppy Shift 3 (You may pay 3 ⬡ to play this on\\ntop of one of your Puppy characters.)",
                    "keyword": "Puppy Shift",
                    "keywordValue": "3",
                    "keywordValueNumber": 3,
                    "reminderText": "You may pay 3 ⬡ to play this on top of one of your Puppy characters.",
                    "type": "keyword"
          },
          {
                    "fullText": "Bodyguard (This character may enter play exerted.\\nAn opposing character who challenges one of\\nyour characters must choose one with Bodyguard\\nif able.)",
                ...
                fullTextSections: [
          "Puppy Shift 3 (You may pay 3 ⬡ to play this on\\ntop of one of your Puppy characters.)",
          "Bodyguard (This character may enter play exerted.\\nAn opposing character who challenges one of\\nyour characters must choose one with Bodyguard\\nif able.)"
],
                cost: 5,
                type: 'Character' as CardType,
    ...
    describe('Calhoun - Courageous Rescuer', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "keywordValue": "4",
                    "keywordValueNumber": 4,
                    "reminderText": "You may pay 4 ⬡ to play this on top of one of your characters named Calhoun.",
                    "type": "keyword"
          },
          {
    ...
    describe('Wreck-It Ralph - Hero\'s Duty', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "During your turn, whenever one of your other characters is banished, this character gets +1 ◊ this turn.",
    ...
    describe('Lady - Miss Park Avenue', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "keywordValue": "3",
                    "keywordValueNumber": 3,
                    "reminderText": "You may pay 3 ⬡ to play this on top of one of your characters named Lady.",
                    "type": "keyword"
          },
          {
    ...
    describe('Minnie Mouse - Storyteller', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "Whenever this character quests, chosen opposing character loses ¤ equal to this character's ◊ until the start of your next turn.",
                    "fullText": "JUST ONE MORE Whenever this character quests,\\nchosen opposing character loses ¤ equal to this\\ncharacter's ◊ until the start of your next turn.",
                    "name": "JUST ONE MORE",
                    "type": "triggered"
          }
],
    ...
    describe('Calhoun - Battle-Tested', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "When you play this character, you may choose and discard a card to give chosen opposing character -3 ¤ until the start of your next turn.",
                    "fullText": "TACTICAL ADVANTAGE When you play this character,\\nyou may choose and discard a card to give chosen\\nopposing character -3 ¤ until the start of your next\\nturn.",
    ...
    describe('Spaghetti Dinner', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "FINE DINING ⟳, 1 ⬡ — If you have 2 or more\\ncharacters in play, gain 1 lore.",
                    "name": "FINE DINING",
                    "type": "activated"
          }
],
                fullTextSections: [
          "FINE DINING ⟳, 1 ⬡ — If you have 2 or more\\ncharacters in play, gain 1 lore."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Kanine Krunchies', () => {
        it('should parse 1 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "effect": "Your Puppy characters get +1 ⛉.",
    ...
    describe('The Glass Slipper', () => {
        it('should parse 2 abilities', () => {
          ...
          "SEARCH THE KINGDOM Banish this item, ⟳ one of your\\nPrince characters — Search your deck for a Princess\\ncharacter card and reveal it to all players. Put that card\\ninto your hand and shuffle your deck."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Te Kā - Elemental Terror', () => {
        it('should parse 2 abilities', () => {
            const card = {
                ...
                abilities: [
          {
                    "fullText": "Shift 7 (You may pay 7 ⬡ to play this on top of\\none of your characters named Te Kā.)",
                    "keyword": "Shift",
                    "keywordValue": "7",
                    "keywordValueNumber": 7,
                    "reminderText": "You may pay 7 ⬡ to play this on top of one of your characters named Te Kā.",
                    "type": "keyword"
          },
          {
