...
describe('Parser Batch 17', () => {
    ...
    describe('The Wardrobe - Perceptive Friend', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "costsText": "⟳, Choose and discard an item card",
                    "effect": "Draw 2 cards.",
                    "fullText": "I HAVE JUST THE THING! ⟳, Choose and discard\\nan item card — Draw 2 cards.",
                    "name": "I HAVE JUST THE THING!",
                    "type": "activated"
          }
],
                fullTextSections: [
          "I HAVE JUST THE THING! ⟳, Choose and discard\\nan item card — Draw 2 cards."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Mrs. Potts - Head Housekeeper', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "effect": "Draw a card.",
                    "fullText": "CLEAN UP ⟳, Banish one of your items — Draw a card.",
                    "name": "CLEAN UP",
                    "type": "activated"
          }
],
                fullTextSections: [
          "CLEAN UP ⟳, Banish one of your items — Draw a card."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Nani - Heist Mastermind', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "STICK TO THE PLAN ⟳ — Another chosen character\\ngains Resist +2 this turn. (Damage dealt to them is\\nreduced by 2.)",
          ...
          },
          {
                ...
                fullTextSections: [
          "STICK TO THE PLAN ⟳ — Another chosen character\\ngains Resist +2 this turn. (Damage dealt to them is\\nreduced by 2.)",
    ...
    describe('Stitch - Experiment 626', () => {
        it('should parse 2 abilities', () => {
          ...
          {
                    "effect": "At the start of your turn, if this card is in your discard, you may choose and discard a card with ◉ to play this character for free and he enters play exerted.",
    ...
    describe('Belle\'s Favorite Book', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "costsText": "⟳, Banish one of your other items",
                    "effect": "Put the top card of your deck into your inkwell facedown and exerted.",
                    "fullText": "CHAPTER THREE ⟳, Banish one of your other items —\\nPut the top card of your deck into your inkwell\\nfacedown and exerted.",
                    "name": "CHAPTER THREE",
                    "type": "activated"
          }
],
                fullTextSections: [
          "CHAPTER THREE ⟳, Banish one of your other items —\\nPut the top card of your deck into your inkwell\\nfacedown and exerted."
],
                cost: 3,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Mechanical Snake', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "DISASSEMBLED SERPENT ⟳, Banish this item — Jafar gains\\n2 lore.",
          ...
          "DISASSEMBLED SERPENT ⟳, Banish this item — Jafar gains\\n2 lore."
],
                cost: 0,
                type: 'Item' as CardType,
                inkwell: true,
    ...
    describe('Giant Hourglass', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "RISING SAND ⟳ — Jafar deals 1 damage to each\\nopposing character.",
                    "name": "RISING SAND",
                    "type": "activated"
          }
],
                fullTextSections: [
          "RISING SAND ⟳ — Jafar deals 1 damage to each\\nopposing character."
],
                cost: 6,
                type: 'Item' as CardType,
                inkwell: true,
