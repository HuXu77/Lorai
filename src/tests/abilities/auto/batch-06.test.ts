...
describe('Parser Batch 6', () => {
    ...
    describe('Lucky Dime', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "NUMBER ONE ⟳, 2 ⬡ — Choose a character of yours\\nand gain lore equal to their ◊.",
                    "name": "NUMBER ONE",
                    "type": "activated"
          }
],
                fullTextSections: [
          "NUMBER ONE ⟳, 2 ⬡ — Choose a character of yours\\nand gain lore equal to their ◊."
],
                cost: 7,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Scrooge\'s Top Hat', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "BUSINESS EXPERTISE ⟳ — You pay 1 ⬡ less for the\\nnext item you play this turn.",
                    "name": "BUSINESS EXPERTISE",
                    "type": "activated"
          }
],
                fullTextSections: [
          "BUSINESS EXPERTISE ⟳ — You pay 1 ⬡ less for the\\nnext item you play this turn."
],
                cost: 2,
                type: 'Item' as CardType,
                inkwell: false,
    ...
    describe('Hades - Hotheaded Ruler', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "CALL THE TITANS ⟳ — Ready your Titan characters.",
                    "name": "CALL THE TITANS",
                    "type": "activated"
          }
],
                fullTextSections: [
          "CALL THE TITANS ⟳ — Ready your Titan characters."
],
                cost: 6,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('Lythos - Rock Titan', () => {
        it('should parse 2 abilities', () => {
          ...
          },
          {
                    ...
                    "fullText": "STONE SKIN ⟳ — Chosen character gains Resist\\n+2 this turn.",
                    "name": "STONE SKIN",
                    "type": "activated"
          }
],
          ...
          "STONE SKIN ⟳ — Chosen character gains Resist\\n+2 this turn."
],
                cost: 4,
                type: 'Character' as CardType,
                inkwell: true,
    ...
    describe('And Then Along Came Zeus', () => {
        it('should parse 1 abilities', () => {
          ...
          {
                    "effect": "A character with cost 4 or more can ⟳ to sing this song for free.",
                    "fullText": "(A character with cost 4 or more can ⟳ to sing this song for free.)",
                    "type": "static"
          }
],
                fullTextSections: [
    ...
    describe('Map of Treasure Planet', () => {
        it('should parse 2 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "KEY TO THE PORTAL ⟳ — You pay 1 ⬡ less for the next location\\nyou play this turn.",
          ...
          },
          {
                ...
                fullTextSections: [
          "KEY TO THE PORTAL ⟳ — You pay 1 ⬡ less for the next location\\nyou play this turn.",
    ...
    describe('And Then Along Came Zeus', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                ...
                fullTextSections: [
          "(A character with cost 4 or more can ⟳ to sing this song\\nfor free.)",
          "Deal 5 damage to chosen character or location."
],
                cost: 4,
                type: 'Action' as CardType,
    ...
    describe('Gaston - Despicable Dealer', () => {
        it('should parse 1 abilities', () => {
                ...
                abilities: [
          {
                    ...
                    "fullText": "DUBIOUS RECRUITMENT ⟳ — You pay 2 ⬡ less\\nfor the next character you play this turn.",
                    "name": "DUBIOUS RECRUITMENT",
                    "type": "activated"
          }
],
                fullTextSections: [
          "DUBIOUS RECRUITMENT ⟳ — You pay 2 ⬡ less\\nfor the next character you play this turn."
],
                cost: 3,
                type: 'Character' as CardType,
                inkwell: false,
